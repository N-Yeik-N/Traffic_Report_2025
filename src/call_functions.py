...
project_names = {
    ...
    3: "Mejoramiento del servicio de transitabilidad de la red semafórica de los ejes viales: Av. Piramide del Sol, Av. Chinchaysuyo, Av. Gran Chimu, Av. Riva Aguero, Av. Ancash, Av. Cesar Vallejo, Av. Lurigancho, Av. Portada del Sol, en los distritos de El Agustino y San Juan de Lurigancho de la Provincia de Lima - Departamento de Lima",
    4: "Mejoramiento y ampliación del servicio de transitabilidad de la red semafórica de los ejes viales: Av. Defensores del Morro, Av. Miguel Grau, Av. Pedro de Osma, Av. San Martin, Av. El Sol Oeste, Ca. Teodocio Parreño, Av. Lima, Av. Guardia Civil, Av. Chorrillos, Av. Ariosto Matellini, Av. Alameda Sur, Av. El Sol, Av. Alameda San Marcos, Av. Guardia Peruana, Av. Mariscal Castilla, en los distritos de Chorrillos y Barranco de la Provincia de Lima - Departamento de Lima",
